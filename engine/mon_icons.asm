...
; type is partymon icon
	assert SPRITE_ANIM_INDEX_PARTY_MON == 0
	xor a
...
.loop
	...
	ld a, SPRITE_ANIM_SEQ_PARTY_MON_SWITCH
	jr z, .join_back
	assert SPRITE_ANIM_SEQ_PARTY_MON_SWITCH + 1 == SPRITE_ANIM_SEQ_PARTY_MON_SELECTED
	inc a ; SPRITE_ANIM_SEQ_PARTY_MON_SELECTED
.join_back
	push hl
	ld c, l
	ld b, h

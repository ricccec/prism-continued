SECTION "Second Map Headers", ROMX
	...
	connection north, ROUTE_74, Route74, 5, 15, 10, SPURGE_CITY
	...
	connection south, ROUTE_69_NORTH, Route69North, 0, 0, 10, HEATH_VILLAGE
	...
	map_header_2 LaurelLab, LAUREL_LAB, $0, 0
	...
	map_header_2 Route87, ROUTE_87, $31, NORTH
	connection north, TUNOD_WATERWAY, TunodWaterway, 0, 8, 10, ROUTE_87
	...
	connection west, ROUTE_82, Route82, 0, 1, 10, ACANIA_DOCKS
	...
	map_header_2 Route69South, ROUTE_69_SOUTH, $61, 0

	map_header_2 Route69SouthGate, ROUTE_69_SOUTH_GATE, $27, 0
	map_header_2 Route69IlkBrotherHouse, ROUTE_69_ILKBROTHERHOUSE, $4, 0
	map_header_2 Route70, ROUTE_70, 53, SOUTH
	connection south, CAPER_RIDGE, CaperRidge, -3, 2, 16, ROUTE_70

	map_header_2 Route71West, ROUTE_71_WEST, $71, WEST | EAST
	connection west, CAPER_RIDGE, CaperRidge, 0, 0, 9, ROUTE_71_WEST
	connection east, ROUTE_71_EAST, Route71East, 0, 7, 16, ROUTE_71_WEST

	map_header_2 Route71East, ROUTE_71_EAST, 113, WEST
	connection west, ROUTE_71_WEST, Route71West, 0, -7, 16, ROUTE_71_EAST
	...
	connection south, SPURGE_CITY, SpurgeCity, 10, 0, 16, ROUTE_74
	...
	connection east, ACANIA_DOCKS, AcaniaDocks, 1, 0, 15, ROUTE_82
	...
	map_header_2 LaurelForestLab, LAUREL_FOREST_LAB, $0, 0
	...
	map_header_2 MersonCity, MERSON_CITY, $2c, NORTH | SOUTH | WEST
	connection north, ROUTE_55, Route55, 0, 0, 10, MERSON_CITY
	connection south, SOUTH_RIJON_GATE, SouthRijonGate, 0, 0, 10, MERSON_CITY
	...
	connection west, ROUTE_64, Route64, 3, 0, 10, HAYWARD_CITY
	connection east, ROUTE_63, Route63, 3, 0, 10, HAYWARD_CITY

	map_header_2 SouthRijonGate, SOUTH_RIJON_GATE, 67, NORTH
	connection north, MERSON_CITY, MersonCity, 0, 0, 10, SOUTH_RIJON_GATE
	...
	map_header_2 HaywardEarthquakeLab, HAYWARD_EARTHQUAKE_LAB, $0, 0
	...
	connection south, ROUTE_58, Route58, 6, 0, 10, BOTAN_CITY
	...
	map_header_2 EagulouCity, EAGULOU_CITY, 67, EAST
	...
	connection north, BOTAN_CITY, BotanCity, 0, 6, 10, ROUTE_58
	...
	map_header_2 SilphWarehouseF1, SILPH_WAREHOUSE_F1, $0, 0
	...
	map_header_2 PowerPlantLobby, POWER_PLANT_LOBBY, $0, 0
	map_header_2 PowerPlant1F, POWER_PLANT_1F, $0, 0
	map_header_2 PowerPlant2F, POWER_PLANT_2F, $1, 0
	map_header_2 PowerPlant3F, POWER_PLANT_3F, $1, 0
	...
	connection west, HAYWARD_CITY, HaywardCity, -3, 0, 10, ROUTE_63

	map_header_2 Route64, ROUTE_64, $f, SOUTH | EAST
	connection south, ROUTE_59, Route59, 0, 25, 10, ROUTE_64
	connection east, HAYWARD_CITY, HaywardCity, 0, 3, 10, ROUTE_64
	...
	map_header_2 SilphCo, SILPH_CO, $0, 0
	...
	map_header_2 EmberBrook, EMBER_BROOK, $35, 0
	...
	connection south, MT_EMBER_SOUTH, MrEmberSouth, 0, 3, 13, MT_EMBER_WEST
	
	map_header_2 MtEmberSouth, MT_EMBER_SOUTH, $43, NORTH
	connection north, MT_EMBER_WEST, MtEmberWest, 3, 0, 13, MT_EMBER_SOUTH
	; ***** Prism continued end *****
	...
	connection south, ROUTE_87, Route87, 8, 0, 10, TUNOD_WATERWAY

	map_header_2 SoutherlyCity, SOUTHERLY_CITY, $31, SOUTH | WEST
	connection south, SOUTH_SOUTHERLY, SouthSoutherly, 5, 0, 15, SOUTHERLY_CITY
	connection west, ESPO_CLEARING, EspoClearing, 5, 0, 18, SOUTHERLY_CITY
	...
	map_header_2 SoutherlyMagnetTrain, SOUTHERLY_MAGNET_TRAIN, $0, 0
	...
	map_header_2 EspoClearing, ESPO_CLEARING, $0a, EAST
	connection east, SOUTHERLY_CITY, SoutherlyCity, 0, 5, 17, ESPO_CLEARING

	map_header_2 EspoForest, ESPO_FOREST, $0, 0

	map_header_2 OlcanChine, OLCAN_CHINE, $9, 0

	map_header_2 OlcanChineEntrance, OLCAN_CHINE_ENTRANCE, $9, 0

	map_header_2 OlcanIsle, OLCAN_ISLE, $01, 0

	map_header_2 OlcanPokecenter, OLCAN_POKECENTER, $0, 0

	map_header_2 OlcanDockExit, OLCAN_DOCK_EXIT, $1, 0

	map_header_2 OlcanDock, OLCAN_DOCK, $0, 0
	...
	map_header_2 FarawayIslandInside, FARAWAY_ISLAND_INSIDE, $61, 0

	map_header_2 Route69North, ROUTE_69_NORTH, 17, NORTH
	connection north, HEATH_VILLAGE, HeathVillage, 0, 0, 13, ROUTE_69_NORTH

	map_header_2 Route69NorthGate, ROUTE_69_NORTH_GATE, 39, 0

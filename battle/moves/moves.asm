...
ENDM
	...
	move DOUBLESLAP,    EFFECT_MULTI_HIT,          15, FAIRY_T,  PHYSICAL,   85,    10,     0 ;retyped to fairy
	...
	move BULK_UP,       EFFECT_BULK_UP,             0, FIGHTING, STATUS,      0,    20,     0
	...
	move DRAININGKISS,  EFFECT_LEECH_HIT,          50, FAIRY_T,  SPECIAL,   100,    10,     0
	move IRON_DEFENSE,  EFFECT_DEFENSE_UP_2,        0, STEEL,    STATUS,      0,    15,   100
	move SWORDS_DANCE,  EFFECT_ATTACK_UP_2,         0, FIGHTING, STATUS,      0,    20,     0
	...
	move WHIRLWIND,     EFFECT_WHIRLWIND,           0, NORMAL,   STATUS,      0,    20,     0
	move FLY,           EFFECT_FLY,                90, FLYING,   PHYSICAL,   95,    15,     0
	move BUG_BUZZ,      EFFECT_SP_DEF_DOWN_HIT,    90, BUG,      SPECIAL,   100,    10,    10
	move NATURE_POWER,  EFFECT_NATURE_POWER,        0, CURSE_T,  STATUS,      0,    20,     0
	...
	move COSMIC_POWER,  EFFECT_COSMIC_POWER,        0, PSYCHIC,  STATUS,      0,    20,     0
	...
	move PRISM_SPRAY,   EFFECT_PRISM_SPRAY,       100, PRISM_T,  SPECIAL,   100,    20,     0 ;new
	...
	move AURA_SPHERE,   EFFECT_ALWAYS_HIT,         80, FIGHTING, SPECIAL,     0,    20,     0
	...
	move ROAR,          EFFECT_WHIRLWIND,           0, SOUND,    STATUS,      0,    20,     0
	...
	move MIST,          EFFECT_MIST,                0, ICE,      STATUS,      0,    30,     0
	...
	move GROWTH,        EFFECT_GROWTH,              0, NORMAL,   STATUS,      0,    20,     0
	...
	move HYPER_VOICE,   EFFECT_NORMAL_HIT,         90, SOUND,    SPECIAL,   100,    10,     0 ;retyped to sound
	...
	move FIRE_SPIN,     EFFECT_BIND,               35, FIRE,     SPECIAL,    85,    15,     0
	...
	move DOUBLE_TEAM,   EFFECT_EVASION_UP,          0, NORMAL,   STATUS,      0,    15,     0
	move RECOVER,       EFFECT_HEAL,                0, PSYCHIC,  STATUS,      0,     5,     0
	move HARDEN,        EFFECT_DEFENSE_UP,          0, NORMAL,   STATUS,      0,    30,     0
	move MINIMIZE,      EFFECT_EVASION_UP_2,        0, NORMAL,   STATUS,      0,    10,     0
	...
	move DEFENSE_CURL,  EFFECT_DEFENSE_CURL,        0, NORMAL,   STATUS,      0,    40,     0
	move BARRIER,       EFFECT_DEFENSE_UP_2,        0, PSYCHIC,  STATUS,      0,    20,     0
	move LIGHT_SCREEN,  EFFECT_LIGHT_SCREEN,        0, PSYCHIC,  STATUS,      0,    30,     0
	move HAZE,          EFFECT_HAZE,                0, ICE,      STATUS,      0,    30,     0
	move REFLECT,       EFFECT_REFLECT,             0, PSYCHIC,  STATUS,      0,    20,     0
	move FOCUS_ENERGY,  EFFECT_FOCUS_ENERGY,        0, NORMAL,   STATUS,      0,    30,     0
	move ASTONISH,      EFFECT_FLINCH_HIT,         30, GHOST,    PHYSICAL,  100,    15,    30
	move METRONOME,     EFFECT_METRONOME,           0, CURSE_T,  STATUS,      0,    10,     0
	...
	move SMOG,          EFFECT_POISON_HIT,         30, GAS,      SPECIAL,    70,    20,    40 ;retyped to gas
	...
	move STORM_FRONT,   EFFECT_HURRICANE,          80, FLYING,   SPECIAL,   100,    10,    30 ;new
	move SWIFT,         EFFECT_ALWAYS_HIT,         60, NORMAL,   SPECIAL,     0,    20,     0
	move AQUA_JET,      EFFECT_PRIORITY_HIT,       40, WATER,    PHYSICAL,  100,    20,     0
	move DUST_DEVIL,    EFFECT_TORNADO,            80, ROCK,     SPECIAL,   100,    10,    30 ;new
	move FLASH_CANNON,  EFFECT_SP_DEF_DOWN_HIT,    80, STEEL,    SPECIAL,   100,    10,    10
	move AMNESIA,       EFFECT_SP_DEF_UP_2,         0, PSYCHIC,  STATUS,      0,    20,     0
	move WILL_O_WISP,   EFFECT_WILL_O_WISP,         0, FIRE,     STATUS,     85,    15,     0
	move SOFTBOILED,    EFFECT_HEAL,                0, NORMAL,   STATUS,      0,     5,     0
	move HI_JUMP_KICK,  EFFECT_JUMP_KICK,         130, FIGHTING, PHYSICAL,   90,    10,     0
	move BURNING_MIST,  EFFECT_BURN_HIT,           90, GAS,      PHYSICAL,  100,    10,    30 ;new
	move DREAM_EATER,   EFFECT_DREAM_EATER,       100, PSYCHIC,  SPECIAL,   100,    15,     0
	move POISON_GAS,    EFFECT_POISON,              0, GAS,      STATUS,     90,    40,     0
	move SEED_BOMB,     EFFECT_NORMAL_HIT,         80, GRASS,    PHYSICAL,  100,    15,     0
	move LEECH_LIFE,    EFFECT_LEECH_HIT,          20, BUG,      PHYSICAL,  100,    15,     0
	move SHOCK_SMOG,    EFFECT_PARALYZE_HIT,      110, GAS,      PHYSICAL,   70,    10,    30 ;new
	move SKY_ATTACK,    EFFECT_SKY_ATTACK,        140, FLYING,   PHYSICAL,   90,     5,    30
	move TRANSFORM,     EFFECT_TRANSFORM,           0, CURSE_T,  STATUS,      0,    10,     0
	move BUBBLE,        EFFECT_SPEED_DOWN_HIT,     40, WATER,    SPECIAL,   100,    30,    10
	move DIZZY_PUNCH,   EFFECT_CONFUSE_HIT,        70, FAIRY_T,  PHYSICAL,  100,    10,    20 ;retyped to fairy
	move SPRING_BUDS,   EFFECT_SPRING_BUDS,        75, GRASS,    PHYSICAL,   90,    10,    30 ;new
	move FLASH,         EFFECT_ACCURACY_DOWN,       0, NORMAL,   STATUS,    100,    20,     0
	move BASS_TREMOR,   EFFECT_NORMAL_HIT,        100, SOUND,    PHYSICAL,  100,    10,     0 ;new
	move SPLASH,        EFFECT_SPLASH,              0, NORMAL,   STATUS,      0,    40,     0
	move ACID_ARMOR,    EFFECT_DEFENSE_UP_2,        0, POISON,   STATUS,      0,    20,     0
	...
	move REST,          EFFECT_HEAL,                0, PSYCHIC,  STATUS,      0,     5,     0
	move ROCK_SLIDE,    EFFECT_FLINCH_HIT,         75, ROCK,     PHYSICAL,   90,    10,    30
	move METEOR_MASH,   EFFECT_METEOR_MASH,        90, STEEL,    PHYSICAL,   90,    10,    20
	move VOID_SPHERE,   EFFECT_NORMAL_HIT,         90, NORMAL,   SPECIAL,   100,    15,     0 ;new (type effect: always neutral)
	move CONVERSION,    EFFECT_CONVERSION,          0, NORMAL,   STATUS,      0,    30,     0
	move TRI_ATTACK,    EFFECT_TRI_ATTACK,         80, TRI_T,    SPECIAL,   100,    10,    20 ;retyped to TRI (fusion of fire/ice/elec)
	move DRAGON_CLAW,   EFFECT_NORMAL_HIT,         80, DRAGON,   PHYSICAL,  100,    15,     0
	move SLASH,         EFFECT_NORMAL_HIT,         70, NORMAL,   PHYSICAL,  100,    20,     0
	move SUBSTITUTE,    EFFECT_SUBSTITUTE,          0, CURSE_T,  STATUS,      0,    10,     0
	move STRUGGLE,      EFFECT_RECOIL_HIT,         50, NORMAL,   PHYSICAL,    0,     1,     0
	move CRYSTAL_BOLT,  EFFECT_NORMAL_HIT,         75, ELECTRIC, SPECIAL,   100,    20,     0 ;new (type effect: hits ground neutrally)
	...
	move MIND_READER,   EFFECT_LOCK_ON,             0, PSYCHIC,  STATUS,      0,     5,     0
	move AERIAL_ACE,    EFFECT_ALWAYS_HIT,         60, FLYING,   PHYSICAL,    0,    20,     0
	...
	move CURSE,         EFFECT_CURSE,               0, CURSE_T,  STATUS,      0,    10,     0
	...
	move PROTECT,       EFFECT_PROTECT,             0, NORMAL,   STATUS,      0,    10,     0
	...
	move FEINT_ATTACK,  EFFECT_ALWAYS_HIT,         60, DARK,     PHYSICAL,    0,    20,     0
	move SWEET_KISS,    EFFECT_CONFUSE,             0, FAIRY,    STATUS,     75,    10,     0
	move BELLY_DRUM,    EFFECT_BELLY_DRUM,          0, NORMAL,   STATUS,      0,    10,     0
	...
	move SPIKES,        EFFECT_SPIKES,              0, GROUND,   STATUS,      0,    20,     0
	move ZAP_CANNON,    EFFECT_PARALYZE_HIT,      120, ELECTRIC, SPECIAL,    50,     5,   100
	move FORESIGHT,     EFFECT_FORESIGHT,           0, NORMAL,   STATUS,      0,    40,     0
	move DESTINY_BOND,  EFFECT_DESTINY_BOND,        0, GHOST,    STATUS,      0,     5,     0
	move PERISH_SONG,   EFFECT_PERISH_SONG,         0, SOUND,    STATUS,      0,     5,     0
	...
	move SANDSTORM,     EFFECT_SANDSTORM,           0, ROCK,     STATUS,      0,    10,     0
	move GIGA_DRAIN,    EFFECT_LEECH_HIT,          75, GRASS,    SPECIAL,   100,    10,     0
	move ENDURE,        EFFECT_ENDURE,              0, NORMAL,   STATUS,      0,    10,     0
	...
	move MEAN_LOOK,     EFFECT_MEAN_LOOK,           0, DARK,     STATUS,      0,     5,     0
	move ATTRACT,       EFFECT_ATTRACT,             0, NORMAL,   STATUS,    100,    15,     0
	move SLEEP_TALK,    EFFECT_SLEEP_TALK,          0, SOUND,    STATUS,      0,    10,     0
	move HEAL_BELL,     EFFECT_HEAL_BELL,           0, SOUND,    STATUS,      0,     5,     0
	...
	move SAFEGUARD,     EFFECT_SAFEGUARD,           0, NORMAL,   STATUS,      0,    25,     0
	move PAIN_SPLIT,    EFFECT_PAIN_SPLIT,          0, NORMAL,   STATUS,      0,    20,     0
	...
	move BATON_PASS,    EFFECT_BATON_PASS,          0, NORMAL,   STATUS,      0,    40,     0
	...
	move MIASMA,        EFFECT_DEFENSE_DOWN_HIT,   90, GAS,      SPECIAL,   100,    10,    40 ;new
	move MORNING_SUN,   EFFECT_MORNING_SUN,         0, NORMAL,   STATUS,      0,     5,     0
	move SYNTHESIS,     EFFECT_SYNTHESIS,           0, GRASS,    STATUS,      0,     5,     0
	move MOONLIGHT,     EFFECT_MOONLIGHT,           0, FAIRY,    STATUS,      0,     5,     0
	...
	move RAIN_DANCE,    EFFECT_RAIN_DANCE,          0, WATER,    STATUS,      0,     5,     0
	move SUNNY_DAY,     EFFECT_SUNNY_DAY,           0, FIRE,     STATUS,      0,     5,     0
	move CRUNCH,        EFFECT_DEFENSE_DOWN_HIT,   80, DARK,     PHYSICAL,  100,    15,    20
	move BOIL,          EFFECT_NORMAL_HIT,         65, FIRE,     SPECIAL,    95,    10,     0 ;new (type effect: hits water super effective)
	...
	move STEEL_EATER,   EFFECT_NORMAL_HIT,         70, POISON,   PHYSICAL,   95,    15,     0 ;new (type effect: hits steel super-effectively)
	move GHOST_HAMMER,  EFFECT_NORMAL_HIT,         85, GHOST,    PHYSICAL,  100,    15,     0 ;new (type effect: hits normal neutrally)
	...
	move NOISE_PULSE,   EFFECT_CONFUSE_HIT,        80, SOUND,    SPECIAL,   100,    15,    20 ;new
